...
#define Move_Rated_UpAcc				((int32_t)(300 * Move_Pulse_NUM))					//(固件额定加速加速度)(1000r/ss)
#define Move_Rated_DownAcc			((int32_t)(300 * Move_Pulse_NUM))					//(固件额定减速加速度)(1000r/ss)
#define Move_Rated_UpCurrentRate		((int32_t)(5 * Current_Rated_Current))	//(固件额定增流梯度)(20倍额定/s)
#define Move_Rated_DownCurrentRate	((int32_t)(5* Current_Rated_Current))	//(固件额定减流梯度)(20倍额定/s)
